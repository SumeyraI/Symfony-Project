...
class Category
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\University", mappedBy="category")
     */
    ...
    public function removeUniversity(University $university): self
    {
        if ($this->universities->contains($university)) {
            ...
            if ($university->getCategory() === $this) {
                $university->setCategory(null);
            }
