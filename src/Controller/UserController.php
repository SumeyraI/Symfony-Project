...
class UserController extends AbstractController
{
    ...
    /**
     * @Route("/haberler", name="user_haberler", methods={"GET"})
     */
    public function haberler(): Response
    {
        return $this->render('user/haberler.html.twig');
    }

    /**
     * @Route("/reservation", name="user_reservation", methods={"GET"})
     */
    ...
    public function newcomment(Request $request, $id): Response
    {
        ...
        if ($form->isSubmitted()) {
            if ($this->isCsrfTokenValid('comment', $submittedToken)) {
                ...
                return $this->redirectToRoute('university_show', ['id' => $id]);
            }
